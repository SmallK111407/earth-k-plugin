...
export function getdsc(qq) {
    const tag_data = {
        "正面常用": {
		 ...
		 "身份": {
			...
			"达达利亚": "Ajax,",
			"艾尔海森": "Alhaitham,",
			"亚瑟王": "Altria Pendragon-2006,",
			"小天城": "Amagi,",
			"小天城A": "AmagiA,",
			"天宫心" : "Amamiya Kokoro,",
			"或守鞠亚A": "Arusu Maria-final,",
			"绫波": "Ayanami,",
			"芭芭拉": "Barbara,",
			"小林历奇": "Copano Rickey,",
			"真机伶": "Curren Chan,",
			...
			"JOJO": "JOJO,",
			"凯尔希": "Kaltsit,",
			"神里绫华A": "Kamisato AyakaA,",
			"神里绫华B": "Kamisato AyakaB,",
			"康娜": "Kanna Kamui,",
			"霞泽美游": "Kasumizawa Miyu,",
			"霞泽美游A": "Kasumizawa MiyuA,",
			"刻晴": "Keqing,",
			"上杉绘梨衣": "Kim Hui-won-ori,",
			"圣王光环": "King Halo,",
			"忍野忍": "Kissshot Acerolaorion Heartunderblade,",
			"北部玄驹": "Kitasan Black,",
			"可莉": "Klee,",
			"可可萝": "Kokkoro,",
			"九条裟罗": "Kujou Sara,",
			...
			"珊瑚宫心海A": "Sangonomiya KokomiA,",
			"英梨梨": "Sawamura Spencer Eriri,",
			"青云天空": "Seiun Sky,",
		    "申鹤": "Shenhe,",
			"申鹤A": "ShenheA,",
			"下江小春": "Shimoe Koharu,",
			"下江小春A": "Shimoe KoharuA,",
			"白洲梓": "Shirasu Azusa,",
			"空崎阳奈": "Sorasaki Hina,",
			"砂糖": "Sucrose,",
			"铃兰": "Suzuran,",
			...
			"大凤": "Taihou,",
			"天童爱丽丝": "Tendou Arisu,",
			"鸢一折纸": "Tobiichi Origami-cf,",
			"鸢一折纸": "Tobiichi Origami-fz,",
			"鸢一折纸B": "Tobiichi Origami-lz,",
			"东海帝王": "Tokai Teio,",
			"时崎狂三": "Tokisaki Kurumi,",
			"时崎狂三A": "Tokisaki KurumiA,",
			"时崎狂三B": "Tokisaki KurumiB,",
			"托尔": "Toru,",
			"独角兽": "Unicorn,",
			"魈": "Xiao,",
			"八重神子": "Yae Miko,",
    ...
    let ch = "有[发色]色的[头发]和[眼色]色的眼睛，[二次元]，[胸]，服装是[衣服]和[鞋子]，佩戴[装饰]装饰，属性是[类型]，身份是[身份],"
    let en = []
