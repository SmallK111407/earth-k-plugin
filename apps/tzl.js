...
export class tzl extends plugin {
    constructor() {
        super({
            ...
            rule: [{
                    /** 命令正则匹配 */
                    reg: "^#加入大话骰$", //匹配消息正则,命令正则
                    /** 执行方法 */
                    fnc: 'jryx'
                },{
                    /** 命令正则匹配 */
                    reg: "^#开始大话骰$|我叫(.*)", //匹配消息正则,命令正则
                    /** 执行方法 */
                    fnc: 'ksyx'
                },{
                    /** 命令正则匹配 */
                    reg: "^#发起大话骰$", //匹配消息正则,命令正则
                    /** 执行方法 */
                    fnc: 'jryx'
                },{
                    /** 命令正则匹配 */
                    reg: "^#结束大话骰$", //匹配消息正则,命令正则
                    /** 执行方法 */
                    fnc: 'jsyx'
                },{
                    /** 命令正则匹配 */
                    reg: "^#大话骰规则$", //匹配消息正则,命令正则
                    /** 执行方法 */
                    fnc: 'tzgz'
                },{
                    /** 命令正则匹配 */
    ...
    async ksyx(e) {
        ...
        if(e.msg.includes('我叫') & game==1){
           ...
           if(caice == daan){
            ...
            data1 = {
                tplFile: './plugins/earth-k-plugin/resources/nhwc/nhwc.html',
                dz: ml,
                wjname: wjname1,
                fen: fen,
                huihe: huihe1,
