...
let gjc =[]
let tx = []
export class gsjl extends plugin {
    constructor() {
        super({
            /** 功能名称 */
            name: '土块故事接龙',
            ...
            rule: [{
                    /** 命令正则匹配 */
                    reg: "^#加入故事接龙$", //匹配消息正则,命令正则
                    /** 执行方法 */
                    fnc: 'jryx'
                },{
                    /** 命令正则匹配 */
                    reg: "^#开始故事接龙$|讲述(.*)", //匹配消息正则,命令正则
                    /** 执行方法 */
                    fnc: 'ksyx'
                },{
                    /** 命令正则匹配 */
                    reg: "^#发起故事接龙$", //匹配消息正则,命令正则
                    /** 执行方法 */
                    fnc: 'jryx'
                },{
                    /** 命令正则匹配 */
                    reg: "^#结束故事接龙$", //匹配消息正则,命令正则
                    /** 执行方法 */
                    fnc: 'jsyx'
                }
    ...
    async ksyx(e) {
        ...
        if(e.msg.includes('讲述') & game==1){
           ...
           if(e.user_id == wanjia[huihe]){
            ...
            data1 = {
                tplFile: './plugins/earth-k-plugin/resources/gsjl/cyy.html',
                dz: ml,
                wjname: wjname1,
                msr:msr,
                gsnr:gsnr,
